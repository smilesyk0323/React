...
function Exam01(){
    ...
    //- React는 화면을 자동으로 갱신해주기 때문에 불변값이 아니라면 처리를 안해준다
    ...
    return(
        <>
            ...
            <button className="btn btn-outline-primary" onClick={plus}>+</button>
            <button className="btn btn-outline-primary ms-2" onClick={minus}>-</button>
        </>
    );
}
